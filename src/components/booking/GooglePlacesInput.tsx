  ...
  const selectPlace = async (place: any) => {
    try {
      ...
      if (details) {
        ...
        // Pass the selection up; parent handles validation and error display below the input
    ...
    <div className={cn("relative", className)}>
      <div className="relative">
        ...
        <Input
          ...
          onFocus={(e) => { onFocusField?.(); if (value) setShowSuggestions(true); }}
        ...
        <div className="absolute top-full left-0 right-0 z-50 mt-1 bg-background border border-glass-border rounded-lg shadow-lg max-h-60 overflow-y-auto">
          {suggestions.map((place: any) => (
            <button
              ...
              // Use onMouseDown so selection happens before input blur hides the list
              onMouseDown={(e) => {
                e.preventDefault();
                selectPlace(place);
              }}
