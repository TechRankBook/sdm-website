...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: MapPin,
      title: "Visit Us",
      details: ["SDM E-Mobility HQ", "Bangalore, Karnataka, India"],
  ...
  const faqItems = [
    {
      ...
      answer: "You can book through our mobile app or website. Select your service, choose vehicle, pay 20% advance, and track your ride."
    },
    {
      question: "What payment methods do you accept?",
      answer: "We accept UPI, credit/debit cards, digital wallets (Paytm, PhonePe, Google Pay), and cash payments."
    },
    {
      question: "How much advance payment is required?",
      answer: "A minimum of 20% advance payment is required to confirm your booking. The remaining amount can be paid after the ride."
    },
    {
      question: "Are all vehicles electric?",
      answer: "Yes, our entire fleet is 100% electric, ensuring zero emissions and a quieter, more comfortable ride experience."
    },
    {
      question: "Can I schedule rides in advance?",
      answer: "Yes, you can schedule rides up to 30 days in advance using the 'Schedule for Later' option in our app."
    },
    {
      question: "What if I need to cancel my ride?",
      answer: "You can cancel rides through the app. Cancellation charges may apply based on timing and our cancellation policy."
    }
  ];
        ...
        <div className="container mx-auto px-4 py-20">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            {contactInfo.map((info) => (
              <Card key={info.title} className="glass p-6 text-center">
                ...
                <Badge variant="secondary" className="mt-2">{info.description}</Badge>
              </Card>
            ))}
          </div>
            ...
            <Card className="glass p-8">
              ...
              <div className="space-y-4">
                {faqItems.map((faq, index) => (
                  <div key={index} className="border-b border-glass-border pb-4">
              ...
              <div className="mt-6 p-4 bg-gradient-surface rounded-lg">
                <p className="text-sm">
                  <strong>Need immediate help?</strong> Call our 24/7 support line or chat with us on WhatsApp 
          ...
          <Card className="glass p-8 text-center">
            ...
            <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
              ...
              use our emergency contact options available 24/7.
            </p>
